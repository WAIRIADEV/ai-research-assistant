      ...
      `}>
        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between mb-4 gap-2">
            <div className="flex items-center gap-2 flex-1 min-w-0">
              <BookOpen className="w-5 h-5 lg:w-6 lg:h-6 text-blue-600 dark:text-blue-400 flex-shrink-0" />
              <h1 className="text-base lg:text-xl font-bold text-gray-800 dark:text-white truncate">
                Research Assistant
              </h1>
            </div>
            <button
        ...
        <div className="p-4 space-y-2">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors text-sm font-medium"
          >
